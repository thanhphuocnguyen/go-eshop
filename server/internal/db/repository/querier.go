...
type Querier interface {
	...
	GetImageFromID(ctx context.Context, id int32) (Image, error)
	...
	GetProductImageByExternalID(ctx context.Context, externalID string) (Image, error)
	GetProductImagesProductID(ctx context.Context, entityID uuid.UUID) ([]GetProductImagesProductIDRow, error)

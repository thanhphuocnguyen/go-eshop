...
type Querier interface {
	...
	GetCategoryProducts(ctx context.Context, categoryID int32) ([]Product, error)
	GetCategoryWithProduct(ctx context.Context, categoryID int32) ([]GetCategoryWithProductRow, error)

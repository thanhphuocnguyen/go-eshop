...
INSERT INTO sessions (
    ...
    $1, $2, $3, $4, $5, $6, $7
) RETURNING session_id, user_id, refresh_token, user_agent, client_ip, blocked, expired_at, created_at
`
...
SELECT session_id, user_id, refresh_token, user_agent, client_ip, blocked, expired_at, created_at FROM sessions

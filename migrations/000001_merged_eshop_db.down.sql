...
DROP INDEX IF EXISTS idx_payment_transactions_gateway_transaction_id;
...
DROP INDEX IF EXISTS idx_discount_usage_discount_id;
DROP INDEX IF EXISTS idx_discount_rules_discount_id;
DROP INDEX IF EXISTS idx_discounts_type;

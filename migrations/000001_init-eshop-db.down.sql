...
DROP CONSTRAINT payment_infos_user_id_fkey;
...
DROP CONSTRAINT attribute_values_attribute_id_fkey;

ALTER TABLE "shippings"
DROP CONSTRAINT shippings_order_id_fkey;
...
ALTER TABLE "orders"
DROP CONSTRAINT orders_shipping_id_fkey;

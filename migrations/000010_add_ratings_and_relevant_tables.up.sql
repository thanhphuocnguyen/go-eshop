...
-- -- Create rating_images table for image attachments to reviews
-- CREATE TABLE
--     rating_images (
--         id UUID PRIMARY KEY,
...
-- -- Create indexes for rating_images table
-- CREATE INDEX idx_rating_images_rating_id ON rating_images(rating_id);
